...
class Target:
    ...
    def run(self):
        ...
        distance_min = 2
        tracks_id = 0
        list_of_tracks = [["track %d" % tracks_id, [(147, 223)]]]
        list_of_points = []
        first = True
        while True:
            ...
            if first:
                ...
                cv.ConvertScale(color_image, self.moving_average, 1.0, 0.0)
                first = False
            else:
                cv.RunningAvg(color_image, self.moving_average, 0.020, None)
