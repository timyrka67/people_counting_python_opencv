...
class Visualization():
    ...
    def add_line(self, color_image, frame_height, frame_width, font, line_p1_x=0, line_p2_x=200, line_p1_y=200,
...
class Target:
    ...
    def run(self):
        ...
        while True:
            ...
            line_and_text.add_line(color_image, self.frame_height, self.frame_width, font, line_p1_x=line_point_1[0],
                                   line_p1_y=line_point_1[1], line_p2_x=line_point_2[0], line_p2_y=line_point_2[1],
            ...
            while contour:
                ...
                for track in list_of_tracks:
                    ...
                    line_and_text.add_line(color_image, self.frame_height, self.frame_width, font, line_p1_x=x_prev,
